...
const translations: Record<string, Record<TranslationKey, string | string[]>> = {
  en: {
    ...
    'challenges.rent.description': 'Get paid faster and save hours every month. Our automated reminders encourage on-time payments (can significantly improve consistency) and free you from chasing tenants, giving you back valuable time.',
    ...
    'kpi.roi.value': '6-8 Weeks',
    'kpi.roi.label': 'Typical time to see initial positive impact',
  ...
  fr: {
    ...
    'challenges.rent.description': 'Soyez payé plus rapidement et économisez des heures chaque mois. Nos rappels automatisés favorisent les paiements ponctuels (améliorant significativement la régularité) et vous libèrent de la chasse aux locataires, vous redonnant un temps précieux.',
    ...
    'kpi.introText': 'Basé sur les résultats typiques obtenus par des gestionnaires immobiliers comme vous:',
    ...
    'kpi.roi.value': '6-8 Semaines',
    'kpi.roi.label': 'Délai typique pour constater l\'impact positif initial',
    'kpi.footnote': '*Estimations basées sur des scénarios clients typiques. Métriques réelles de partenaires pilotes à venir bientôt.',
